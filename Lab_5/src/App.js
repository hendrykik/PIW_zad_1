...
import { logInWithGoogle, useAuth, logout, logInWithFacebook } from "./UserService";
  ...
  return (
    <Box p={8}>
      <Flex justifyContent="space-between" alignItems="center">
        ...
        />
        <h2>Witaj legionisto {user.displayName}</h2>
    ...
    <Box p={8}>
      <Flex justifyContent="space-between" alignItems="center">
        ...
        <button onClick={ logInWithGoogle }>
                Login with big Google</button>
            <button onClick={ logInWithFacebook }>
                Login with big Facebook</button>
        <Select onChange={handleSortChange} w={48} placeholder="Sortuj po">
          <option value="price-asc">Cena rosnąco</option>
          <option value="price-desc">Cena malejąco</option>
        </Select>
